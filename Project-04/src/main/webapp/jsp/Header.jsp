...
%>
    ...
    <a href="<%=ORSView.MARKSHHET_MERIT_LIST_CTL%>"><b>MarkSheet Merit List</b></a> <b>|</b>
    ...
    <a href="<%=ORSView.TIME_TABLE_CTL%>"><b>Add Timetable</b></a> <b>|</b>
    <a href="<%=ORSView.TIME_TABLE_LIST_CTL%>"><b>Timetable List</b></a> <b>|</b>
    <a href="<%=ORSView.FACULTY_CTL%>"><b>Add Faculty</b></a> <b>|</b>
    <a href="<%=ORSView.FACULTY_LIST_CTL%>"><b>Faculty List</b></a> <b>|</b>
     <a href="<%=ORSView.PATIENT_CTL%>"><b>Add Patient</b></a> <b>|</b>
     <a href="<%=ORSView.PATIENT_LIST_CTL%>"><b>Patient List</b></a> <b>|</b>
